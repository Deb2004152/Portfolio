    ...
    <>
      <div className={` h-screen w-full pt-[6vw] ${theme==="light"?"bg-[rgb(247,245,243)]":"bg-[rgb(11,17,32)]"} `}>
         ...
         <div className="flex justify-items-start text-[rgb(125,125,125)] text-[1.1vw] gap-[1.2vw] mt-[1.5vw] ml-[5vw]">
           <div onClick={()=>window.open("https://www.w3schools.com/html/")} className={` SkillAnimation  cursor-pointer h-[2.5vw] w-[6vw] pt-[0.1vw]  border-[0.1vw]  rounded-[1vw] flex justify-between pl-[0.2vw] ${theme==="light"?"hover:border-blue-400 bg-[rgb(251,250,249)] border-gray-300 text-black":"bg-[rgb(24,33,56)] border-[rgb(42,52,75)] text-gray-300 hover:border-amber-200"} `}><div className="size-[1.8vw] bg-center bg-cover " style={{ backgroundImage: `url(${theme==="light" ? html:Html})` }}></div><p className="mt-[0.3vw] mr-[0.8vw]">Html</p></div>
           <div onClick={()=>window.open("https://www.w3schools.com/css/")} className={` SkillAnimation  cursor-pointer h-[2.5vw] w-[6vw] pt-[0.1vw]  border-[0.1vw]  rounded-[1vw] flex justify-between pl-[0.2vw] ${theme==="light"?"hover:border-blue-400 bg-[rgb(251,250,249)] border-gray-300 text-black":"bg-[rgb(24,33,56)] border-[rgb(42,52,75)] text-gray-300 hover:border-amber-200"} `}><div className="size-[1.8vw] bg-center bg-cover " style={{ backgroundImage: `url(${theme==="light" ? css:Css})` }}></div><p className="mt-[0.3vw] mr-[1.2vw]">CSS</p></div>
           <div onClick={()=>window.open("https://www.w3schools.com/js/")} className={` SkillAnimation  cursor-pointer h-[2.5vw] w-[5vw] pt-[0.2vw]  border-[0.1vw]  rounded-[1vw] flex justify-between pl-[0.2vw] ${theme==="light"?"hover:border-blue-400 bg-[rgb(251,250,249)] border-gray-300 text-black":"bg-[rgb(24,33,56)] border-[rgb(42,52,75)] text-gray-300 hover:border-amber-200"} `}><div className="size-[2vw] bg-center bg-cover " style={{ backgroundImage: `url(${theme==="light" ? js:javascript})` }}></div><p className="mt-[0.2vw] mr-[1vw]">JS</p></div>
           <div onClick={()=>window.open("https://react.dev/learn")} className={` SkillAnimation  cursor-pointer h-[2.5vw] w-[7vw] pt-[0.2vw]  border-[0.1vw]  rounded-[1vw] flex justify-between pl-[0.2vw] ${theme==="light"?"hover:border-blue-400 bg-[rgb(251,250,249)] border-gray-300 text-black":"bg-[rgb(24,33,56)] border-[rgb(42,52,75)] text-gray-300 hover:border-amber-200"} `}><div className="size-[2vw] bg-center bg-cover " style={{ backgroundImage: `url(${theme==="light" ? react:reactjs})` }}></div><p className="mt-[0.2vw] mr-[0.5vw]">React Js</p></div>
           <div onClick={()=>window.open("https://redux-toolkit.js.org/introduction/getting-started")} className={` SkillAnimation  cursor-pointer h-[2.5vw] w-[7vw] pt-[0.2vw]  border-[0.1vw]  rounded-[1vw] flex justify-between pl-[0.2vw] ${theme==="light"?"hover:border-blue-400 bg-[rgb(251,250,249)] border-gray-300 text-black":"bg-[rgb(24,33,56)] border-[rgb(42,52,75)] text-gray-300 hover:border-amber-200"} `}><div className="size-[1.8vw] bg-center bg-cover " style={{ backgroundImage: `url(${theme==="light" ? redux:Redux})` }}></div><p className="mt-[0.2vw] mr-[0.8vw]">Redux</p></div>
           <div onClick={()=>window.open("https://nodejs.org/en")} className={` SkillAnimation  cursor-pointer h-[2.5vw] w-[7vw] pt-[0.2vw]  border-[0.1vw]  rounded-[1vw] flex justify-between pl-[0.2vw] ${theme==="light"?"hover:border-blue-400 bg-[rgb(251,250,249)] border-gray-300 text-black":"bg-[rgb(24,33,56)] border-[rgb(42,52,75)] text-gray-300 hover:border-amber-200"} `}><div className="size-[2vw] bg-center bg-cover " style={{ backgroundImage: `url(${theme==="light" ? node:nodejs})` }}></div><p className="mt-[0.2vw] mr-[0.4vw]">Node js</p></div>
           <div onClick={()=>window.open("https://expressjs.com/")} className={` SkillAnimation  cursor-pointer h-[2.5vw] w-[8vw] pt-[0.2vw]  border-[0.1vw]  rounded-[1vw] flex justify-between pl-[0.2vw] ${theme==="light"?"hover:border-blue-400 bg-[rgb(251,250,249)] border-gray-300 text-black":"bg-[rgb(24,33,56)] border-[rgb(42,52,75)] text-gray-300 hover:border-amber-200"} `}><div className="size-[2vw] bg-center bg-cover " style={{ backgroundImage: `url(${theme==="light" ? express:expressjs})` }}></div><p className="mt-[0.2vw] mr-[0.4vw]">Express js</p></div>
           <div onClick={()=>window.open("https://www.mongodb.com/")} className={` SkillAnimation  cursor-pointer h-[2.5vw] w-[8vw] pt-[0.2vw]  border-[0.1vw]  rounded-[1vw] flex justify-between pl-[0.2vw] ${theme==="light"?"hover:border-blue-400 bg-[rgb(251,250,249)] border-gray-300 text-black":"bg-[rgb(24,33,56)] border-[rgb(42,52,75)] text-gray-300 hover:border-amber-200"} `}><div className="size-[2vw] bg-center bg-cover " style={{ backgroundImage: `url(${theme==="light" ? mongodb:Mongodb})` }}></div><p className="mt-[0.2vw] mr-[0.7vw]">Mongodb</p></div>
           <div onClick={()=>window.open("https://www.mysql.com/")} className={` SkillAnimation  cursor-pointer h-[2.5vw] w-[7vw] pt-[0.2vw]  border-[0.1vw]  rounded-[1vw] flex justify-between pl-[0.2vw] ${theme==="light"?"hover:border-blue-400 bg-[rgb(251,250,249)] border-gray-300 text-black":"bg-[rgb(24,33,56)] border-[rgb(42,52,75)] text-gray-300 hover:border-amber-200"} `}><div className="size-[2.1vw] bg-center bg-cover " style={{ backgroundImage: `url(${theme==="light" ? sql:mysql})` }}></div><p className="mt-[0.2vw] mr-[0.4vw]">MySQL</p></div>
           <div onClick={()=>window.open("https://www.w3schools.com/c/c_intro.php")} className={` SkillAnimation  cursor-pointer h-[2.5vw] w-[4vw] pt-[0.2vw]  border-[0.1vw]  rounded-[1vw] flex justify-between pl-[0.2vw] ${theme==="light"?"hover:border-blue-400 bg-[rgb(251,250,249)] border-gray-300 text-black":"bg-[rgb(24,33,56)] border-[rgb(42,52,75)] text-gray-300 hover:border-amber-200"} `}><div className="size-[1.8vw] bg-center bg-cover " style={{ backgroundImage: `url(${theme==="light" ? c:Clanguage})` }}></div><p className="mt-[0.2vw] mr-[0.8vw]">C</p></div>
           <div onClick={()=>window.open("https://www.w3schools.com/cpp/")} className={` SkillAnimation  cursor-pointer h-[2.5vw] w-[5vw] pt-[0.2vw]  border-[0.1vw]  rounded-[1vw] flex justify-between pl-[0.2vw] ${theme==="light"?"hover:border-blue-400 bg-[rgb(251,250,249)] border-gray-300 text-black":"bg-[rgb(24,33,56)] border-[rgb(42,52,75)] text-gray-300 hover:border-amber-200"} `}><div className="size-[1.8vw] bg-center bg-cover " style={{ backgroundImage: `url(${theme==="light" ? cpp:Cpp})` }}></div><p className="mt-[0.2vw] mr-[0.3vw]">C++</p></div>
           <div onClick={()=>window.open("https://www.python.org/")} className={` SkillAnimation  cursor-pointer h-[2.5vw] w-[7vw] pt-[0.2vw]  border-[0.1vw]  rounded-[1vw] flex justify-between pl-[0.2vw] ${theme==="light"?"hover:border-blue-400 bg-[rgb(251,250,249)] border-gray-300 text-black":"bg-[rgb(24,33,56)] border-[rgb(42,52,75)] text-gray-300 hover:border-amber-200"} `}><div className="size-[2vw] bg-center bg-cover " style={{ backgroundImage: `url(${theme==="light" ? py:python}) ` }}></div><p className="mt-[0.2vw] mr-[0.8vw]">Python</p></div>
         </div>
      </div>
    </>
  )
