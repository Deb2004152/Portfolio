...
export default function SkillCard() {
  ...
  return (
    <>
      <div className="hover:border-blue-400 hover:bg-amber-50 cursor-pointer SkillAnimation flex text-[1.1vw] flex-col gap-[1.2vw] pt-[0.8vw] text-[rgb(125,125,125)] pl-[2vw] h-[20vw] w-[16vw] bg-[rgb(251,250,249)] border-[0.1vw] border-gray-300 rounded-[1vw] ">
